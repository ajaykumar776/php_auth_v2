...
if($_SERVER["REQUEST_METHOD"] == "POST"){		/*if the method is post , then only.*/
	try{
		...
		// $userdeatils= trim([$_REQUEST['deatils']]);
		...
		$result = mysqli_query($con, "insert into users values ('$user_name','$user_email','$user_pass');");		/*If there is not match , means its for new registration, then we will register them.*/
		if($result){
...
<div class="container-fluid">
	...
	<!-- <h1 style="text-align: center;padding:10px; border:2px solid black; background-color:#993300; ">Registration form </h1> -->
	<div class="row">
		<div class="col-sm-4 col-sm-offset-4 my-div">
			...
			<?php endif;?>
				<!--action is on the same page, and method is post-->
			<form action="register.php" method="post">	
			<h1 style="text-align: center;padding:10px; border:2px solid black; background-color:yellow; ">Registration form </h1>	
				...
				<br>
				<p>If You have already registered then <br><a href="login.php"style="color:white">Click  here to Loggin</a></p>
